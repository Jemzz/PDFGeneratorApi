...
{
    public class ValuationPDFConfig : PDFAbstractConfig
    {
        public override async Task<byte[]> BuildPDF(string mainContent, Dictionary<string, string> additionalContent)
        {
            ...
            var headerImageFile = "Content/Brand/MWise-logoRGB-180.png";
            ...
            var footerImageFile = "Content/Brand/simplified-investing-180.png";
            ...
            for (var tocItem = 1; tocItem <= 7 /*int.Parse(additionalContent.Where(x => x.Key == "sections").FirstOrDefault().Value)*/; tocItem++)
            {
